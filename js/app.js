(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider-product-card__slider")) {
            let thumbsSwiper = new core(".thumb-slider-product-card__slider", {
            ...
            new core(".main-slider-product-card__slider", {
